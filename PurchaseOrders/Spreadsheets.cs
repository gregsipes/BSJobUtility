...
namespace PurchaseOrders
{
    public partial class frmMain
    {
        ...
        private ClsSpreadsheet CreatePurchaseOrderSpreadsheet(OrderClass currentOrder)
        {
        ...
        private ClsSpreadsheet CreateExpenseReportSpreadsheet(OrderClass currentOrder)
        {
            ...
            ClsSpreadsheet xlER = new ClsSpreadsheet(xlPath);
            ...
            try
            {
                ...
                int desiredheight = 2 * xlER.Style.GetRowHeight(LINE1);
                OrderClass o = currentOrder;
                for (int i = 0; i < o.NumLineItems; i++)
                {
                    int row = LINE1 + i;
