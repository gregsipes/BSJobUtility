                            ...
                            switch (currentSegmentName)
                            {
                                ...
                                case "S1":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.OfficePay, "dbo.Proc_Insert_Subscription_S1",
                                               ...
                                               new SqlParameter("@end_grace_date", lineSegments[lineSegmentCounter + 4].ToString() == "" || lineSegments[lineSegmentCounter + 4].ToString() == "?" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 4].ToString()),
                                ...
                                case "S2":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.OfficePay, "dbo.Proc_Insert_Subscription_S2",
                                               ...
                                               new SqlParameter("@pbs_record_number", lineNumber),
                                               new SqlParameter("@segment_instance", SGCount),
                                               new SqlParameter("@original_start_date", lineSegments[lineSegmentCounter + 1].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 1].ToString()),
                                               new SqlParameter("@source_of_last_start", lineSegments[lineSegmentCounter + 2].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 2].ToString()),
                                               new SqlParameter("@subsource_of_last_start", lineSegments[lineSegmentCounter + 3].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 3].ToString()),
                                               new SqlParameter("@credit_status", lineSegments[lineSegmentCounter + 4].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 4].ToString()),
                                               new SqlParameter("@occupant_type", lineSegments[lineSegmentCounter + 5].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 5].ToString()),
                                               new SqlParameter("@census_tract", lineSegments[lineSegmentCounter + 6].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 6].ToString()),
                                               new SqlParameter("@dwelling_type", lineSegments[lineSegmentCounter + 7].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 7].ToString()),
                                               new SqlParameter("@abc_zone", lineSegments[lineSegmentCounter + 8].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 8].ToString()),
                                               new SqlParameter("@method_of_renewal_delivery", lineSegments[lineSegmentCounter + 9].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 9].ToString()));
                                    break;
                                case "EG":
                                    EGCount++;
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.OfficePay, "dbo.Proc_Insert_End_EG",
                                               ...
                                               new SqlParameter("@number_of_subscribers_in_group", lineSegments[lineSegmentCounter + 1].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 1].ToString()),
                                               new SqlParameter("@last_field", (object)DBNull.Value));
                                    break;
                                case "F1":
                                    F1Count++;
                                ...
                                case "B1":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.OfficePay, "dbo.Proc_Insert_Bill_To_B1",
                                               ...
                                               new SqlParameter("@zip_extension", lineSegments[lineSegmentCounter + 6].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 6].ToString()),
                                               new SqlParameter("@delivery_point_code", lineSegments[lineSegmentCounter + 7].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 7].ToString()),
                                               new SqlParameter("@po_route_type", lineSegments[lineSegmentCounter + 8].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 8].ToString()),
                                               new SqlParameter("@bill_to_indicator", lineSegments[lineSegmentCounter + 9].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 9].ToString()),
                                               new SqlParameter("@bill_to_occupant_id", lineSegments[lineSegmentCounter + 10].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 10].ToString()),
                                               new SqlParameter("@bill_to_address_id", lineSegments[lineSegmentCounter + 11].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 11].ToString()),
                                               new SqlParameter("@bill_to_full_billing_name", lineSegments[lineSegmentCounter + 12].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 12].ToString()),
                                               new SqlParameter("@bill_to_other_name", lineSegments[lineSegmentCounter + 13].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 13].ToString()),
                                               new SqlParameter("@imb", lineSegments[lineSegmentCounter + 14].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 14].ToString()),
                                               new SqlParameter("@encoded_imb_mixed_case", lineSegments[lineSegmentCounter + 15].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 15].ToString()),
                                               new SqlParameter("@encoded_imb_uppercase", lineSegments[lineSegmentCounter + 16].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 16].ToString()),
                                               new SqlParameter("@bill_to_address_isonline", lineSegments[lineSegmentCounter + 17].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 17].ToString()));
                                    break;
                                case "C1":
                                    C1Count++;
                                ...
                                case "R2":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.OfficePay, "dbo.Proc_Insert_Rate_R2",
                                                   new SqlParameter("@loads_id", loadsId),
                                                    ...
                                                    new SqlParameter("@combo_id", lineSegments[lineSegmentCounter + 1].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 1].ToString()),
                                                    new SqlParameter("@subscription_number", lineSegments[lineSegmentCounter + 2].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 2].ToString()),
                                                    new SqlParameter("@product_id", lineSegments[lineSegmentCounter + 3].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 3].ToString()),
                                                    new SqlParameter("@delivery_method", lineSegments[lineSegmentCounter + 4].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 4].ToString()),
                                                    new SqlParameter("@delivery_schedule", lineSegments[lineSegmentCounter + 5].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 5].ToString()),
                                                    new SqlParameter("@rate_code", lineSegments[lineSegmentCounter + 6].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 6].ToString()),
                                                    new SqlParameter("@subscription_rate_description", lineSegments[lineSegmentCounter + 7].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 7].ToString()),
                                                    new SqlParameter("@subscription_rate_before_tax", lineSegments[lineSegmentCounter + 8].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 8].ToString()),
                                                    new SqlParameter("@subscription_rate", lineSegments[lineSegmentCounter + 9].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 9].ToString()),
                                                    new SqlParameter("@total_tax_amount", lineSegments[lineSegmentCounter + 10].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 10].ToString()),
                                                    new SqlParameter("@city_tax_amount", lineSegments[lineSegmentCounter + 11].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 11].ToString()),
                                                    new SqlParameter("@county_tax_amount", lineSegments[lineSegmentCounter + 12].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 12].ToString()),
                                                    new SqlParameter("@state_tax_amount", lineSegments[lineSegmentCounter + 13].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 13].ToString()),
                                                    new SqlParameter("@country_tax_amount", lineSegments[lineSegmentCounter + 14].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 14].ToString()),
                                                    new SqlParameter("@delivery_fee_amount", lineSegments[lineSegmentCounter + 15].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 15].ToString()),
                                                    new SqlParameter("@new_expire_date", lineSegments[lineSegmentCounter + 16].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 16].ToString()));
                                    break;
                                case "T1":
                                    T1Count++;
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.OfficePay, "dbo.Proc_Insert_Tax_T1",
                                                    ...
                                                    new SqlParameter("@country_tax_amount_1", lineSegments[lineSegmentCounter + 1].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 1].ToString()),
                                                    new SqlParameter("@state_tax_amount_1", lineSegments[lineSegmentCounter + 2].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 2].ToString()),
                                                    new SqlParameter("@county_tax_amount_1", lineSegments[lineSegmentCounter + 3].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 3].ToString()),
                                                    new SqlParameter("@city_tax_amount_1", lineSegments[lineSegmentCounter + 4].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 4].ToString()),
                                                    new SqlParameter("@country_tax_amount_2", lineSegments[lineSegmentCounter + 5].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 5].ToString()),
                                                    new SqlParameter("@state_tax_amount_2", lineSegments[lineSegmentCounter + 6].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 6].ToString()),
                                                    new SqlParameter("@county_tax_amount_2", lineSegments[lineSegmentCounter + 7].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 7].ToString()),
                                                    new SqlParameter("@city_tax_amount_2", lineSegments[lineSegmentCounter + 8].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 8].ToString()),
                                                    new SqlParameter("@country_tax_amount_3", lineSegments[lineSegmentCounter + 9].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 9].ToString()),
                                                    new SqlParameter("@state_tax_amount_3", lineSegments[lineSegmentCounter + 10].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 10].ToString()),
                                                    new SqlParameter("@county_tax_amount_3", lineSegments[lineSegmentCounter + 11].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 11].ToString()),
                                                    new SqlParameter("@city_tax_amount_3", lineSegments[lineSegmentCounter + 12].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 12].ToString()),
                                                    new SqlParameter("@country_tax_amount_4", lineSegments[lineSegmentCounter + 13].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 13].ToString()),
                                                    new SqlParameter("@state_tax_amount_4", lineSegments[lineSegmentCounter + 14].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 14].ToString()),
                                                    new SqlParameter("@county_tax_amount_4", lineSegments[lineSegmentCounter + 15].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 15].ToString()),
                                                    new SqlParameter("@city_tax_amount_4", lineSegments[lineSegmentCounter + 16].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 16].ToString()));
                                    break;
                                case "TC":
                                    TCCount++;
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.OfficePay, "dbo.Proc_Insert_Transportation_TC",
                                                    ...
                                                    new SqlParameter("@transportation_cost_1", lineSegments[lineSegmentCounter + 1].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 1].ToString()),
                                                    new SqlParameter("@transportation_cost_2", lineSegments[lineSegmentCounter + 2].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 2].ToString()),
                                                    new SqlParameter("@transportation_cost_3", lineSegments[lineSegmentCounter + 3].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 3].ToString()),
                                                    new SqlParameter("@transportation_cost_4", lineSegments[lineSegmentCounter + 4].ToString() == "" ? (object)DBNull.Value : lineSegments[lineSegmentCounter + 4].ToString()));
                                    break;
                            }
