...
namespace ManifestFreeLoad
{
    public class Job : JobBase
    {
        ...
        public override void ExecuteJob()
        {
            try
            {
                List<string> files = Directory.GetFiles(GetConfigurationKeyValue("InputDirectory"), "freeman*").ToList();
                ...
                if (files != null && files.Count() > 0)
                {
                    foreach (string file in files)
                    {
                        ...
                        Dictionary<string, object> previouslyLoadedFile = ExecuteSQL(DatabaseConnectionStringNames.ManifestsFree, "dbo.Proc_Select_Loads_If_Processed",
                        ...
                        //else
                        //{
                        //    ExecuteNonQuery(DatabaseConnectionStringNames.ManifestsFree, "Proc_Insert_Loads_Not_Loaded",
        ...
        private void CopyAndProcessFile(FileInfo fileInfo)
        {
            ...
            Dictionary<string, object> result = ExecuteSQL(DatabaseConnectionStringNames.ManifestsFree, "Proc_Insert_Loads",
            ...
            ExecuteNonQuery(DatabaseConnectionStringNames.ManifestsFree, "Proc_Update_Loads_Backup",
                ...
                if (line != null && line.Trim().Length > 0)
                {
                    ...
                    if (lineSegments[0] == "R1")
                    {
                        ...
                        else
                        {
                            ...
                            ExecuteNonQuery(DatabaseConnectionStringNames.ManifestsFree, "dbo.Proc_Insert_Route_Detail",
                    ...
                    else if (lineSegments[0] == "R2")
                    {
                        ...
                        {
                            ExecuteNonQuery(DatabaseConnectionStringNames.ManifestsFree, "dbo.Proc_Insert_Advance_Detail",
                                        new SqlParameter("@loads_id", loadsId),
                    ...
                    else if (lineSegments[0] == "R3")
                    {
                        ...
                        {
                            ExecuteNonQuery(DatabaseConnectionStringNames.ManifestsFree, "dbo.Proc_Insert_TM_Detail",
                                       new SqlParameter("@loads_id", loadsId),
                    ...
                    else if (lineSegments[0] == "T1")
                    {
                        ...
                        {
                            ExecuteNonQuery(DatabaseConnectionStringNames.ManifestsFree, "dbo.Proc_Insert_Truck_Totals",
                                       new SqlParameter("@loads_id", loadsId),
                    ...
                    else if (lineSegments[0] == "T2")
                    {
                        ...
                        {
                            ExecuteNonQuery(DatabaseConnectionStringNames.ManifestsFree, "dbo.Proc_Insert_Advance_Totals",
                                       new SqlParameter("@loads_id", loadsId),
                    ...
                    else if (lineSegments[0] == "T3")
                    {
                        ...
                        {
                            ExecuteNonQuery(DatabaseConnectionStringNames.ManifestsFree, "dbo.Proc_Insert_TM_Totals",
                                            new SqlParameter("@loads_id", loadsId),
        ...
        private void LoadRelatedTables(Int32 loadsId, DateTime? runDate, String runType, Int32 totalRecordsProcessed)
        {
            ...
            ExecuteNonQuery(DatabaseConnectionStringNames.ManifestsFree, "dbo.Proc_Insert_Mother_Trucks_Sequence", new SqlParameter("@pintLoadsID", loadsId));
            WriteToJobLog(JobLogMessageType.INFO, "Records inserted into Mother_Trucks_Sequence table.");

            ExecuteNonQuery(DatabaseConnectionStringNames.ManifestsFree, "dbo.Proc_Insert_Relay_Trucks_Sequence", new SqlParameter("@pintLoadsID", loadsId));
            WriteToJobLog(JobLogMessageType.INFO, "Records inserted into Relay_Trucks_Sequence & Relay_Trucks_Sequence tables.");

            ExecuteNonQuery(DatabaseConnectionStringNames.ManifestsFree, "dbo.Proc_Insert_Mother_Trucks_Sequence_For_Loading_Dock", new SqlParameter("@pintLoadsID", loadsId));
            WriteToJobLog(JobLogMessageType.INFO, "Records inserted into Mother_Trucks_Sequence_For_Loading_Dock table.");

            ExecuteNonQuery(DatabaseConnectionStringNames.ManifestsFree, "dbo.Proc_Insert_Editions_Sections_Sequence", new SqlParameter("@pintLoadsID", loadsId));
            WriteToJobLog(JobLogMessageType.INFO, "Records inserted into Editions_Sections_Sequence table.");

            ExecuteNonQuery(DatabaseConnectionStringNames.ManifestsFree, "dbo.Proc_Insert_Editions_Sections_No_AMPM_Sequence", new SqlParameter("@pintLoadsID", loadsId));
            WriteToJobLog(JobLogMessageType.INFO, "Records inserted into Editions_Sections_No_AMPM_Sequence table.");

            ExecuteNonQuery(DatabaseConnectionStringNames.ManifestsFree, "dbo.Proc_Insert_Loads_Latest",
                                                new SqlParameter("@pintLoadsID", loadsId),
