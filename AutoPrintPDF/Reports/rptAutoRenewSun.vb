...
Public Class rptAutoRenewSun
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AutoRenew.rptAutoRenewSun.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAutoRenewSun
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAutoRenewSun = New rptAutoRenewSun()
        rpt.Site = Me.Site
        Return rpt
    End Function
