...
Public Class rptOfficePaySun
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Reporting.rptOfficePaySun.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOfficePaySun
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOfficePaySun = New rptOfficePaySun()
        rpt.Site = Me.Site
        Return rpt
    End Function
