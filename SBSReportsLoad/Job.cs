            ...
            try
            {
                ...
                foreach (Dictionary<string, object> table in tables)
                {
                    ...
                    if (File.Exists(xmlFile))
                    {
                        ...
                        while (!reader.EOF)
                        {
                            if (reader.Name != "tt" + table["table_name"].ToString() + "Row")
                            {
                                reader.ReadToFollowing("tt" + table["table_name"].ToString() + "Row");
                            }
                            if (!reader.EOF)
                            {
                                ...
                                switch (table["table_name"].ToString().ToLower())
                                {
                                    ...
                                    case "empauto":
                                        ...
                                        break;
                                    case "empded2":
                                        if (node.Element("DeductCode").Value.Contains("uf"))
                                        {
                                    ...
                                    case "empgrp2":
                                        ...
                                        break;
                                    case "employee":
                                        if (node.Element("CompanyId").ToString().Contains("BNEWS"))
                                        {
                                            ExecuteNonQuery(DatabaseConnectionStringNames.SBSReports, "Proc_Insert_Employee",
                                                    ...
                                                    new SqlParameter("@NoLocalEx", node.Element("SecondLocalExemptions").Value),
                                                    ...
                                                    // new SqlParameter("@Supervisor", DBNull.Value),
                                    ...
                                    case "pyunion":
                                        ...
                                        break;
                                    case "tcard2":
                                       if (Convert.ToDateTime(node.Element("TrxDate").Value) >= DateTime.Now.AddYears(-3))
                                        {
