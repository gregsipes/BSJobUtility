...
namespace AutoRenew
{
    public class Job : JobBase
    {
        ...
        public override void ExecuteJob()
        {
            try
            {
                List<string> files = Directory.GetFiles(GetConfigurationKeyValue("InputDirectory"), "autorenew??????-???").ToList();
                        ...
                        if (segmentNames.Where(s => s == lineSegment).FirstOrDefault() != null)
                        {
                            ...
                            switch (currentSegmentName)
                            {
                                case "SG":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Start_SG",
                                ...
                                case "S2":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Subscription_S2",
                                               new SqlParameter("@loads_id", loadsId),
                                               new SqlParameter("@pbs_record_number", lineNumber),
                                               new SqlParameter("@segment_instance", SGCount),
                                ...
                                case "EG":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_End_EG",
                                               new SqlParameter("@loads_id", loadsId),
                                               new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "A1":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Auto_Renew_A1",
                                               new SqlParameter("@loads_id", loadsId),
                                               new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "A2":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Auto_Renew_A2",
                                               new SqlParameter("@loads_id", loadsId),
                                               new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "B1":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Bill_To_B1",
                                               new SqlParameter("@loads_id", loadsId),
                                               new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "C1":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Carrier_C1",
                                                  new SqlParameter("@loads_id", loadsId),
                                                 new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "D1":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Delivery_D1",
                                                    new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "X1":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Demographic_X1",
                                                    new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "E1":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Expire_E1",
                                                    new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "G1":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Grace_G1",
                                                    new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "G2":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Grace_G2",
                                                    new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "G3":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Grace_G3",
                                                    new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "G4":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Grace_G4",
                                                    new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "Z0":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Marketing_Z0",
                                                    new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "Z1":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Marketing_Z1",
                                                    new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "Z2":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Marketing_Z2",
                                                   new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "M1":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Message_M1",
                                                    new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "M2":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Message_M2",
                                                    new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "P1":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Payment_P1",
                                                   new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "P2":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Payment_P2",
                                                   new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "R1":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Rate_R1",
                                                   new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "R2":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Rate_R2",
                                                   new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "T1":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Tax_T1",
                                                    new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
                                ...
                                case "TC":
                                    ...
                                    ExecuteNonQuery(DatabaseConnectionStringNames.AutoRenew, "dbo.Proc_Insert_Transportation_TC",
                                                    new SqlParameter("@loads_id", loadsId),
                                                    new SqlParameter("@pbs_record_number", lineNumber),
